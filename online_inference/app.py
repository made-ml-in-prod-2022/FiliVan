...
SOURCE = "gdrive"
DEFAULT_DOWNLOAD_MODEL_PATH = (
    "https://drive.google.com/file/d/1oGfWKZVbueiiMZ1L2f_BqDv0oiIE3uH8/view?usp=sharing"
)
...
@app.api_route("/predict", response_model=List[PredictResponse], methods=["POST"])
